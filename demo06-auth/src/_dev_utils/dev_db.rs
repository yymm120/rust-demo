...
const PG_DEV_POSTGRES_URL: &str = "postgres://postgres:welcome@124.222.48.193/postgres";
// const PG_DEV_POSTGRES_URL: &str = "postgres://postgres:welcome@124.222.48.193/postgres";
const PG_DEV_APP_URL: &str = "postgres://app_user:dev_only_pwd@124.222.48.193/app_db";
// sql files
